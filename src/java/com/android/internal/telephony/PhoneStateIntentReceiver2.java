 ...
 */
@Deprecated
public final class PhoneStateIntentReceiver2 extends BroadcastReceiver {
    ...
    public PhoneStateIntentReceiver2() {
        super();
        mFilter = new IntentFilter();
    }

    public PhoneStateIntentReceiver2(Context context, Handler target) {
        this();
        setContext(context);
        setTarget(target);
    }
    ...
    public void notifyPhoneCallState(int eventWhat) {
        ...
        mFilter.addAction(TelephonyManager.get2ndTm().ACTION_PHONE_STATE_CHANGED);
    }
    ...
    public void notifyServiceState(int eventWhat) {
        ...
        mFilter.addAction(TelephonyIntents2.ACTION_SERVICE_STATE_CHANGED);
    }
    ...
    public void notifySignalStrength (int eventWhat) {
        ...
        mFilter.addAction(TelephonyIntents2.ACTION_SIGNAL_STRENGTH_CHANGED);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            if (TelephonyIntents2.ACTION_SIGNAL_STRENGTH_CHANGED.equals(action)) {
            ...
            } else if (TelephonyManager.get2ndTm().ACTION_PHONE_STATE_CHANGED.equals(action)) {
            ...
            } else if (TelephonyIntents2.ACTION_SERVICE_STATE_CHANGED.equals(action)) {
