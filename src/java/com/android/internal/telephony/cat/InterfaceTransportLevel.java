...
public class InterfaceTransportLevel implements Parcelable {
    ...
    private InterfaceTransportLevel(Parcel in) {
        port = in.readInt();
        protocol = TransportProtocol.values()[port];
    }
   ...
   public void writeToParcel(Parcel dest, int flags) {
    ...
    public static final Parcelable.Creator<InterfaceTransportLevel> CREATOR =
            new Parcelable.Creator<InterfaceTransportLevel>() {
